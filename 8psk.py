...
# Configuration Settings for 8-PSK
M = 8 
...
def start_app():
    ...
    info_bits = np.random.randint(0, 2, 450000)
    ...
    # file_path = os.path.join("rf_dataset", "ml_8psk_samples.npy")
    ...
    file_path = os.path.join("data_equal", "ml_8psk_samples.npy")
    np.save(file_path, ml_ready_matrix)
